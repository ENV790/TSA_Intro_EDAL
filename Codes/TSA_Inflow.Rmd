---
title: "TSA: Trend and Seasonality - Amazon Inflow Modeling"
author: "Luana Lima"
date: "15/06/2023"
...
For this first example we will import water inflow data for reservoirs in Brazil. The original file was imported and cleaned/wrangled in "ImportData.Rmd". Here we are just reading the data already processed and ready to be used for time series analysis. To import the .csv file we will use  *read.csv()*. This function will store the data as a data frame and has useful inputs such as
...
```{r detrendsmooth, message=FALSE, warning=FALSE}
